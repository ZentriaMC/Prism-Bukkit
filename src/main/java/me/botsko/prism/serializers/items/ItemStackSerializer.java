...
public class ItemStackSerializer {
    ...
    public ItemStack toBukkit() {
        ...
        if (meta instanceof LeatherArmorMeta && color > 0) {
            ...
            return deserializeFireWorksMeta(item, meta);
    ...
    public static ItemStackSerializer deserialize(String data) {
        ...
        return GenericAction.gson().fromJson(data, ItemStackSerializer.class);
    }

    private ItemStack deserializeFireWorksMeta(ItemStack item, ItemMeta meta) {
